const zh = {
	...
	oauthBindParamsEmpty: '邮箱或授权信息不能为空',
	...
	emptyToEmail: '收件人邮箱不能为空',
	emptySubject: '邮件标题不能为空',
	emptyEmailContent: '邮件内容不能为空',
	emptyVerifyCode: '邮箱和验证码不能为空',
	invalidVerifyCode: '验证码格式不正确',
	verifyCodeFail: '验证码错误或已过期',
	verifyCodeRateLimit: '验证码发送过于频繁，请稍后再试',
	perms: {
		"邮件": "邮件",
		"邮件发送": "邮件发送",
		"邮件删除": "邮件删除",
