const en = {
	...
	oauthBindParamsEmpty: 'Email or OAuth info cannot be empty',
	...
	emptyToEmail: 'Recipient email cannot be empty',
	emptySubject: 'Email subject cannot be empty',
	emptyEmailContent: 'Email content cannot be empty',
	emptyVerifyCode: 'Email and verification code cannot be empty',
	invalidVerifyCode: 'Invalid verification code format',
	verifyCodeFail: 'Verification code is incorrect or expired',
	verifyCodeRateLimit: 'Too many verification emails, please try again later',
	perms: {
		"邮件": "Emails",
		"邮件发送": "Send Email",
		"邮件删除": "Delete Email",
